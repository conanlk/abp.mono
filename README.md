...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 0c7540ed-9498-40ae-875e-3bb92d7a03bd
```

> `0c7540ed-9498-40ae-875e-3bb92d7a03bd` is the password of the certificate, you can change it to any password you want.
