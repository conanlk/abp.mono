...
namespace Abp.Mono.Web.Menus;

public class MonoMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public MonoMenuContributor(IConfiguration configuration)
    {
    ...
    private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
    {
        ...
        var l = context.GetLocalizer<MonoResource>();
